...
CREATE TABLE `usuarios` ( `id` INT PRIMARY KEY AUTO_INCREMENT, `email` VARCHAR(255) NOT NULL UNIQUE, `senha` VARCHAR(255) NOT NULL, `perfil` ENUM('admin', 'comum') NOT NULL DEFAULT 'comum', `reset_token_hash` VARCHAR(255) NULL DEFAULT NULL, `reset_token_expires_at` DATETIME NULL DEFAULT NULL);
